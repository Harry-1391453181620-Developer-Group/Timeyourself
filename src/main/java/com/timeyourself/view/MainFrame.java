...
import com.timeyourself.controller.Convertor;
...
import com.timeyourself.service.EventService;
...
public class MainFrame {
    ...
    public MainFrame(EmergencyTaskService emergencyTaskService, TaskService taskService, EventService eventService) {
    ...
    private void initialize() {
        ...
        this.frame = new JFrame("Timeyourself");
        this.frame.setSize(2000, 1500);
        this.frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.frame.setBackground(mainBackgroundColor);
        ...
        button1.setAlignmentX(java.awt.Component.CENTER_ALIGNMENT);
        button1.setBackground(buttonBackgroundColor);
        button1.setFont(new Font("Timeyourselflogo", Font.ITALIC, 24));
        button1.addActionListener(e -> {
            new AddTaskEntryDialog(
                    frame,
                    icon,
                    mainBackgroundColor,
                    JTabbedPaneBackgroundColor,
                    buttonBackgroundColor,
                    new AddTaskEntryDialog.TaskCallback() {
                        @Override
                        public void onTaskCreated(Task task) {
                            Convertor.TaskConvertToJTextArea(
                                    panel1,
                                    task,
                                    singleEntryBackgroundColor
                            );
                        }
                    },
                    this.taskService
        ...
        button2.setAlignmentX(java.awt.Component.CENTER_ALIGNMENT);
        button2.setBackground(buttonBackgroundColor);
        button2.setFont(new Font("Timeyourselflogo", Font.ITALIC, 24));
        button2.addActionListener(e -> {
            new AddEmergencyTaskEntryDialog(
                    frame,
                    icon,
                    mainBackgroundColor,
                    JTabbedPaneBackgroundColor,
                    buttonBackgroundColor,
                    new AddEmergencyTaskEntryDialog.EmergencyTaskCallback() {
                        @Override
                        public void onEmergencyTaskCreated(EmergencyTask emergencyTask) {
                            Convertor.EmergencyTaskConvertToJTextArea(
                                    panel2,
                                    emergencyTask,
                                    singleEntryBackgroundColor
                            );
        ...
        title3.setAlignmentX(java.awt.Component.CENTER_ALIGNMENT);
        ...
        button3.setAlignmentX(java.awt.Component.CENTER_ALIGNMENT);
        button3.setBackground(buttonBackgroundColor);
        button3.setFont(new Font("Timeyourselflogo", Font.ITALIC, 24));
        button3.addActionListener(e -> {
            new AddEventEntryDialog(
                    frame,
                    icon,
                    mainBackgroundColor,
                    JTabbedPaneBackgroundColor,
                    buttonBackgroundColor,
                    new AddEventEntryDialog.EventCallback()  {
                        @Override
                        public void onEventCreated(Event event) {
                            Convertor.EventConvertToJTextArea(
                                    panel3,
                                    event,
                                    singleEntryBackgroundColor
                            );
