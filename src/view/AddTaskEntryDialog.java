...
public class AddTaskEntryDialog {
    ...
    public AddTaskEntryDialog(Window parentWindow, ImageIcon icon, Color mainBackgroundColor, Color JTableBackgroundColor, Color buttonBackgroundColor, TaskCallback callback) {
        ...
        gbc.gridy = 0; formPanel.add(new JLabel("Task name: "), gbc);
        gbc.gridy = 1; JTextField nameField = new JTextField(20); formPanel.add(nameField, gbc);

        gbc.gridy = 2; formPanel.add(new JLabel("Task description: "), gbc);
        gbc.gridy = 3; JTextField descField = new JTextField(20); formPanel.add(descField, gbc);

        gbc.gridy = 4; formPanel.add(new JLabel("Task start date: (Format: dd/MM/yyyy HH:mm):"), gbc);
        gbc.gridy = 5; JTextField startField = new JTextField(20); formPanel.add(startField, gbc);

        gbc.gridy = 6; formPanel.add(new JLabel("Task due date: (Format: dd/MM/yyyy HH:mm):"), gbc);
